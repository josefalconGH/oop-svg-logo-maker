...
describe("Circle", () => {
    ...
    test("Creates a new Circle object that is blue", () => {
        ...
        const expected = `<circle cx="150" cy="150" r="100" fill="blue" />`;
...
describe("Triangle", () => {
    ...
    test("Creates a new Triangle obj this is Green", () => {
        // expected output
        const expected = `<polygon points="150, 50 100, 150 200, 150" fill="green" />`;
    ...
    test("Creates a new Triangle object that is purple", () => {
        // Define the expected output
        const expected = `<polygon points="150, 50 100, 150 200, 150" fill="purple" />`;
...
describe("Square", () => {
    ...
    test("Creates a new Square object that is yellow", () => {
        // Define the expected output
        const expected = `<rect x="100" y="100" width="100" height="100" fill="yellow" />`;
...
describe("SVG", () => {
    ...
    test("Creates a new SVG obj with a Circle and Text", () => {
        // expected output
        const expected = `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="150" r="100" fill="red" /><text x="150" y="150" font-family="Verdana" font-size="35" text-anchor="middle" fill="black">SVG</text></svg>`;
        // new instance of circle class
        const circle = new Circle();
        // set color of circle obj to red
        circle.setColor("red");
    ...
    test("Creates a new SVG object with a Triangle and Text", () => {
        // Define the expected output
        const expected = `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><polygon points="150, 50 100, 150 200, 150" fill="green" /><text x="150" y="150" font-family="Verdana" font-size="35" text-anchor="middle" fill="black">SVG</text></svg>`;
        // Create a new instance of the triangle class
        const triangle = new Triangle();
