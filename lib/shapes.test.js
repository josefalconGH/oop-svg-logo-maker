...
describe("SVG", () => {
    ...
    <circle cx="120" cy="105" r="80" style="stroke:purple;stroke-width:3" fill="red"/>

    <text x="120" y="125" font-size="40" text-anchor="middle" fill="black">SVG</text>
    ...
    <polygon points="120, 20 200, 200 40, 200" style="stroke:purple;stroke-width:3" fill="green"/>
